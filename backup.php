...
$bd="turadiop_restaurant_new"; //parametro obligatorio 
// Tipo de compresion. 
...
$conexion = new mysqli('localhost','turadiop_rest','ancw952022.','turadiop_restaurant_new') or die ("No se puede conectar con el servidor MySQL: %s\n". $conexion->connect_error);

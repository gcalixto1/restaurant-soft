...
?>
                                               <tr role="row" class="odd">
                                               <td><?php echo $a++; ?></td>
<td><abbr title="<?php echo "Nº ".$documento = ($reg[$i]['documcliente'] == '0' ? "DOCUMENTO" : $reg[$i]['documento'])." ".$reg[$i]['dnicliente']; ?>"><?php echo $reg[$i]['nomcliente']; ?></abbr></td>
...
<div class="table-responsive"><table id="default_order" class="table table-striped table-bordered border display">
                                                 ...
                                                 <tr role="row">
                                                    ...
                                                    <th>Unidad Medida</th>
                                                    <th>P.V.P</th>
                      <th><?php echo $cambio[0]['codmoneda2'] == '' ? "*****" : "P.V. ".$cambio[0]['siglas']; ?></th>
                                                    <th>Stock</th>
...
<td><?php echo $cambio[0]['codmoneda2'] == '' ? "*****" : "<strong>".$cambio[0]['simbolo']."</strong> ".number_format($reg[$i]['precioventa']/$cambio[0]['montocambio'], 2, '.', ','); ?></td>
...
<td><?php echo $cliente = ( $reg[$i]['codcliente'] == '0' ? "<span class='badge badge-pill badge-warning'><i class='fa fa-times'></i> SIN ASIGNAR</span>" : $reg[$i]['nomcliente']); ?></td>

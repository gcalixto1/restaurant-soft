...
<section id="wrapper" class="new-login-register">
      ...
      <div class="lg-info-panel">
              <div class="">
                  <a href="javascript:void(0)" class="p-10 di"></a>
              </div>
      </div>
      ...
      <div class="new-login-box">
            ...
            <center><img src="https://img.icons8.com/external-microdots-premium-microdot-graphic/100/000000/external-restaurant-lifestyle-entertainment-vol2-microdots-premium-microdot-graphic.png"/></center>
                    <div id="login">
        <!-- error will be shown here ! -->
            ...
            <div class="form-group text-center m-t-20">
              <div class="col-xs-12">
                <button class="btn btn-success btn-lg btn-block text-uppercase" data-toggle="tooltip" data-placement="top" title="" data-original-title="Haga clic aquí para iniciar sesión" name="btn-login" id="btn-login" type="submit"><span class="fa fa-sign-in"></span> Acceder</button>
              </div>
            </div>
            <div class="text-center text-dark">Desarrollado por Ing. Gerson A. Calixto. <br>Cel: +503 6155-5290</div>
            <div class="text-center text-dark">Correo Electrónico: gbite_code@gmail.com</div>
          ...
          <form class="form form-material new-lg-form" name="recoverform" id="recoverform" action="">
            ...
            <h3 class="box-title m-b-0">Recuperar Contraseña</h3>
            ...
            <div class="form-group text-center m-t-20">
              <div class="col-xs-12">
                <button class="btn btn-warning btn-lg btn-block text-uppercase" name="btn-recuperar" id="btn-recuperar" type="submit"><span class="fa fa-check-square-o"></span> Recuperar Contraseña</button>
              </div>
            </div>
            <div class="text-center text-dark">Desarrollado por Ing. Gerson A. Calixto<br>Cel: +503 6155-5290</div>
            <div class="text-center text-dark">Correo Electrónico: gbite_code@gmail.com</div>

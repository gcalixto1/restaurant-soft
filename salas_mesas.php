        ...
        <?php if ($mesa[$ii]['codsala'] == $codigo_sala) { ?>
            ...
            <li style="display:inline;float: left; margin-right: 4px;">
                ...
                <div class="users-list-name codMesa" title="<?php echo $mesa[$ii]['nommesa']; ?>" style="cursor:pointer;" onclick="RecibeMesa('<?php echo encrypt($mesa[$ii]['codmesa']); ?>')">
                    ...
                    <div id="<?php echo $mesa[$ii]['nommesa']; ?>" style="width: 80px;height: 70px;background:<?php if ($mesa[$ii]['statusmesa'] == '0') { ?>#3EA33E;<?php } ?>#640010" class="miMesa"><img src="fotos/mesa.png" style="margin:7.5px;float:center;width:68px;height:50px;"></div>

                    <center><h6><b><?php echo $mesa[$ii]['nommesa']; ?></b></h6></center><br>
  ...
  <ul class="nav nav-tabs customtab" role="tablist">
    ...
    <?php $codigo_cate = $categoria[$i]['codcategoria']; ?>
        ...
        if ($producto[$ii]['codcategoria'] == $codigo_cate && $producto[$ii]['existencia'] > 0) { ?>
            ...
            echo "<img src='fotos/productos/".$producto[$ii]['codproducto'].".jpg?' class='rounded-circle' style='width:120px;height:108px;'>"; 
            ...
            echo "<img src='fotos/producto.png' class='rounded-circle' style='width:120px;height:108px;'>";  } ?>

...
<section id="wrapper" class="new-login-register">
      ...
      <div class="lg-info-panel">
              <div class="inner-panel">
                  <a href="javascript:void(0)" class="p-20 di"><?php if (file_exists("fotos/logo-principal.png")){
                    echo "<img src='fotos/logo-principal.png' width='380' height='110' alt='Logo Principal' class='dark-logo'>"; 
                                    } else {
                    echo "<img src='' width='380' height='110' alt='Logo Principal' class='dark-logo'>"; 
                                    } 
                    ?></a>
                  <div class="lg-content">
                      <h2>SISTEMA PARA LA GESTIÓN DE VENTAS E INVENTARIO </h2>
        ...
        <div class="user-thumb text-center"> 
            ...
            <?php if (isset($_SESSION['dni'])) {
                if (file_exists("fotos/".$_SESSION['dni'].".jpg")){
                    echo "<img src='fotos/".$_SESSION['dni'].".jpg?".date('h:i:s')."' class='img-responsive img-circle img-thumbnail' alt='thumbnail' width='60' height='60'>"; 
                } else {
                    echo "<img src='fotos/avatar.jpg' class='img-responsive img-circle img-thumbnail' alt='thumbnail' width='60' height='60'>"; 
                } } else {
                    echo "<img src='fotos/avatar.jpg' class='img-responsive img-circle img-thumbnail' alt='thumbnail' width='60' height='60'>"; 
                }
                ?>

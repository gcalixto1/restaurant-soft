...
<table border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
         <tr>
           ...
           <th>PRECIO COMPRA</th>
           <th>PRECIO VENTA</th>
           <th><?php echo $cambio[0]['codmoneda2'] == '' ? "CAMBIO" : "PRECIO ".$cambio[0]['siglas']; ?></th>
           <th>EXISTENCIA</th>
<?php if ($documento == "EXCEL") { ?>
           <th>STOCK MINIMO</th>
           <th>STOCK MÁXIMO</th>
...
<td><?php echo $cambio[0]['codmoneda2'] == '' ? "*****" : $cambio[0]['simbolo'].number_format($reg[$i]['precioventa']/$cambio[0]['montocambio'], 2, '.', ','); ?></td>
